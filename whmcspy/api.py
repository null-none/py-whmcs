...
class WHMCS:
    ...
    def __init__(self, url, identifier, secret):
        """
    ...
    def call(self, action, **params):
        ...
        response = requests.post(self.url, verify=False, data=payload)
    ...
    def paginated_call(self, action, limitstart=0, **params):
        """
        ...
        while True:
            ...
            response = self.call(action, **params)
    ...
    def add_product(self, name, gid, **params):
        """
        Add product.
        ...
        """
        result = self.call("AddProduct", name=name, gid=gid, **params)
        return result["pid"]
    ...
    def get_orders(self, **params):
        ...
        """
        for response in self.paginated_call("GetOrders", **params):
    ...
    def get_servers(self, **params):
        ...
        """
        response = self.call("GetServers", **params)
    ...
    def accept_order(self, order_id, **params):
        """
        Accept an order.
        ...
        response = self.call("AcceptOrder", **params)
        return response
    ...
    def add_order(
        ...
        **params,
        ...
        response = self.call("AddOrder", **params)
        return response

    def add_transaction(self, paymentmethod, **params):
        """
        Add a transaction.
        ...
        self.call("AddTransaction", **params)
    ...
    def cancel_order(self, orderid, **params):
        ...
        self.call("CancelOrder", **params)

    def delete_order(self, orderid, **params):
        """
        ...
        self.call("DeleteOrder", **params)

    def get_clients_domains(self, active=None, **params):
        """
        ...
        """
        for response in self.paginated_call("GetClientsDomains", **params):
    ...
    def get_invoice(self, invoiceid):
        ...
        """
        result = self.call("GetInvoice", invoiceid=invoiceid)
        return result
    ...
    def get_transactions(self, **params):
        ...
        """
        response = self.call("GetTransactions", **params)
        return response.get("transactions", {}).get("transaction", [])

    def module_create(self, serviceid):
        """
        ...
        """
        result = self.call("ModuleCreate", serviceid=serviceid)
        return result

    def open_ticket(self, deptid, subject, message, **params):
        """
        ...
        self.call("OpenTicket", **params)

    def pending_order(self, orderid, **params):
        """
    ...
    def send_email(self, **params):
        ...
        """
        result = self.call("SendEmail", **params)

    def update_client_domain(self, domain, **params):
        """
        ...
        response = self.call("UpdateClientDomain", **params)
        return response

    def update_client_product(self, productid, **params):
        """
    ...
    def domain_whois(self, domain, **params):
        ...
        """
        result = self.call("DomainWhois", domain=domain, **params)
        return result

    def domain_register(self, domainid=None, **params):
        """
        ...
        """
        result = self.call("DomainRegister", domainid=domainid, **params)
        return result
